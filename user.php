                            ...
                            ?>
                                <div class="row">
                                    <div class="card-title col-lg-8">
                                        <span><a href="add_new_user.php" class="link-dark"><i class="f-s-20 mr-2 bi bi-person-fill-add"></i>novo usuário</a></span>
                                    </div>
                                    <div class="card-title col-lg-4 text-right">
                                        <span><a href="index.php" class="link-dark">Página Inicial </a></span>|
                                        <span><a href="tool.php" class="link-dark">Ferramentas</a></span>
                                    </div>
                                </div>
                                        ...
                                        <table class="table text-center student-data-table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_user.php?id=<?=$usuario['id']; ?>" class="f-s-20 pr-3" style="color: black;"><i class="bi bi-pencil-square fs5"></i></a>
                                                        <a href="delete_user.php?id=<?= $usuario['id']; ?>" onclick="return confirm('certeza que deseja excluir?')" class="f-s-20 me-3" style="color: black;"><i class="bi bi-trash3-fill"></i></a>
